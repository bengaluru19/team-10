          ...
          <table cellspacing="0" cellpadding="0" width="100%">
            <tr>
              <td class="hide-for-mobile" style="padding:30px 0 10px 0;">
                <img width="200" height="200" src="intro1.jpg" alt="logo" />
              </td>
            </tr>
            ...
            <tr>
              <td class="hide-for-mobile"  height="150" valign="top" >
                <b>
                  <span>AntHill Creations</span>
                  </b>
                <br>
                <span>NSRCEL, IIM Bangalore 
...
India</span>
            ...
            <tr>
              <td class="hide-for-mobile" style="height:180px; width:299px;">
                <img width="200" height="300"src="1.jpeg" alt="large logo" />
              </td>
            </tr>
          </table>
        </td>
                  ...
                  <tr>
                    <td>
                      ...
                      <table cellspacing="0" cellpadding="10" width="100%">
                        <tr>
                          <td class="mobile-padding">
                            Hello, Thank You for showing interest in us.
                          </td>
                      ...
                      <table cellspacing="0" cellpadding="10" width="100%">
                        <tr>
                          <td>
                            <b>Welcome to Anthill Creations<br><br>"Reminder"</b><br>
                            Thank You for completing the survey, we hope to start with your project as soon as possible.<br><br>
You can also track your project status at<br><br>
<href="#"><table cellspacing="0" cellpadding="0" width="100%" style="width:100%"><tr><td style="background-color:#48be19;border-radius:5px;color:#ffffff;display:inline-block;font-family:sans-serif;font-size:16px;line-height:45px;text-align:center;text-decoration:none;width:200px;-webkit-text-size-adjust:none;mso-hide:all;"><span style="color:#ffffff">Take Project Status Now!</span></td></tr></table></a>
                          </td>
                        </tr>
                      </table>
